...
async function run() {
  console.log("Rescoring manually updated usable designer MDs...\n")
  ...
  console.log("\nSummary")
  console.log("-------")
  console.log(`Checked usable files: ${checked}`)
  ...
  await fs.outputJson("output/manual-usable-rescore-summary.json", upgraded, {
    spaces: 2,
  })

  console.log("\nSaved summary:")
  console.log("output/manual-usable-rescore-summary.json")
}
