...
motifs: ["puzzle-fit shapes", "tessellating forms", "positive-negative contrast", "modular units"]
structures: ["tessellation", "all-over", "no-background", "seamless"]
styles: ["geometric", "graphic", "structured", "Escher-influenced"]
categories: ["geometric", "tessellation", "technique"]
source_count: 2
source_files:
