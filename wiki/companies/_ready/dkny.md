---
company_uid: 2ba94f4a-f15f-4224-bf59-0b22c5302416
schema_version: 1
name: DKNY
slug: dkny
...
revenue_text: $675M
website_url: https://www.dkny.com
instagram_url: https://www.instagram.com/DKNY
linkedin_url: https://www.linkedin.com/company/donna-karan/
facebook_url: https://www.facebook.com/DKNY
tiktok_url: https://www.tiktok.com/@dkny
pinterest_url: https://www.pinterest.com/dkny
youtube_url: https://www.youtube.com/@dkny
parent_company_uid: 4bea10a1-cf6d-4b0f-b028-480def53a4bd
type_slugs: []
images:
  logo:
    path: ../../assets/companies/dkny/profile/dkny-logo.webp
    alt: DKNY logo
    width: 886
    height: 886
  gallery:
    - title: Accessories
      alt: DKNY accessories collection
      path: ../../assets/companies/dkny/gallery/dkny-accessories.jpg
      width: 1400
      height: 2100
      source:
        title: Accessories
        page_url: https://www.dkny.com/collections/sunglasses
      affiliate:
        enabled: false
        url: null
    - title: Womens
      alt: DKNY womens collection
      path: ../../assets/companies/dkny/gallery/dkny-womens.jpg
      width: 1400
      height: 2100
      source:
        title: Womens
        page_url: https://www.dkny.com/collections/womens-jacket-sale
      affiliate:
        enabled: false
        url: null
updated: '2026-08-02'
...
![Profile](../../assets/companies/dkny/profile/dkny-logo.webp)

## Gallery Images

| Title | Preview |
|-------|---------|
| Accessories | ![](../../assets/companies/dkny/gallery/dkny-accessories.jpg) |
| Womens | ![](../../assets/companies/dkny/gallery/dkny-womens.jpg) |
...
DKNY launched in 1989 as a diffusion line inspired by Donna Karan's daughter Gaby, targeting casual and weekend wear at accessible price points. Sub-brands include DKNY Jeans, DKNY Active, DKNY Underwear, DKNY Juniors, DKNY Kids, DKNY Pure, and DKNY Men (launched 1992; tailored suits, dress wear, casual wear, sportswear, shoes). Donna Karan Beauty (fragrances) launched 1992. Donna Karan Home (luxury bedding and accessories) and DKNY Home (contemporary and fashion-forward bedding) launched 2001.

In 2013, DKNY collaborated with Opening Ceremony to reissue select 1990s styles. HQ: 550 Seventh Avenue, Manhattan. Global store count: 70+ (Donna Karan and DKNY combined), including China (Hong Kong and Shanghai), Middle East, Canada, and UK. Online retail since 2005. Campaign talent: Cara Delevingne (mid-2010s), Emily Ratajkowski (2017), Kaia Gerber (2024), Hailey Bieber (2025 global ambassador); photographers: Collier Schorr (2017), Mikael Jansson (2025).

## Products

- Clothing: womenswear and menswear RTW (DKNY and sub-labels including DKNY Jeans, DKNY Active)
- Footwear
- Accessories: bags, belts
- Watches: licensed to Fossil Group
- Fragrance: Donna Karan Beauty (from 1992)
- Eyewear (licensed)
- Home: Donna Karan Home and DKNY Home (luxury and contemporary bedding, from 2001)
- Underwear and lingerie (DKNY Underwear)

## Services

Owned by G III Apparel Group (since 2016, $650M acquisition from LVMH). Note: YAML parent_company "fossil-group" reflects the watch licence relationship only. Watches: Fossil Group (licence). HQ: 550 Seventh Avenue, Manhattan. E-commerce: dkny.com (since 2005). Social presence: Instagram (@DKNY), TikTok (@dkny), Pinterest, YouTube, Facebook.
...
- [About](https://www.dkny.com/pages/about-us)
- [Press](https://www.dkny.com)
- [Contact](https://www.dkny.com/pages/contact)
- [Store locator](https://www.dkny.com/pages/stores)
- [Careers](https://www.dkny.com/pages/careers)
