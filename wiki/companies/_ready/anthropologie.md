---
company_uid: 1f3fb491-3658-4b80-80a7-7d8ce971b44c
schema_version: 1
name: Anthropologie
slug: anthropologie
...
instagram_url: https://www.instagram.com/anthropologie/
linkedin_url: https://www.linkedin.com/company/anthropologie/
facebook_url: https://www.facebook.com/Anthropologie/
type_slugs: []
images:
  logo:
    path: ../../assets/companies/anthropologie/profile/anthropologie-logo.jpg
    alt: Anthropologie logo
    width: 1080
    height: 1080
  gallery:
    - title: Clothing
      alt: Anthropologie clothing collection
      path: ../../assets/companies/anthropologie/gallery/anthropologie-clothing.jpg
      width: 1450
      height: 2175
      source:
        title: null
      ...
      affiliate:
        ...
        url: null
    - title: Dresses
      alt: Anthropologie dresses collection
      path: ../../assets/companies/anthropologie/gallery/anthropologie-dresses.jpg
      width: 1450
      height: 2175
      source:
        title: Dresses
        page_url: https://www.anthropologie.com/dresses
      affiliate:
        enabled: false
        url: null
updated: '2026-08-02'
...
![Profile](../../assets/companies/anthropologie/profile/anthropologie-logo.jpg)

## Gallery Images

| Title | Preview |
|-------|---------|
| Clothing | ![](../../assets/companies/anthropologie/gallery/anthropologie-clothing.jpg) |
| Dresses | ![](../../assets/companies/anthropologie/gallery/anthropologie-dresses.jpg) |
...
- Clothing: women's fashion (dresses, tops, bottoms, coats, knitwear, denim)
- Jewellery: fashion and fine jewellery
- Home: furniture, decorations, bedding, textiles, tableware, lighting
- Beauty: skincare, haircare, bodycare
- Gifts: seasonal, occasion, lifestyle gifting
- Shoes and accessories

## Services

Anthropologie is a wholly owned brand within the Urban Outfitters (URBN) corporate portfolio. The external designer collaboration programme operates on a brand-partnership model (co-design for apparel and home collections), not a traditional wholesale or licensing model. The brand operates primarily through freestanding stores and e-commerce, with geographic presence across US, Canada, France, Germany, and UK.

## Markets

Anthropologie competes in the US lifestyle specialty retail market at an accessible-premium price point, positioned between mass-market and luxury. Its competitive differentiation lies in the curated, maximalist bohemian aesthetic expressed consistently across fashion, home, beauty, and gifting. The multi-category lifestyle format and strong external designer collaboration programme distinguish it from pure-fashion specialty retailers.
