...
The Hermès carré de soie is one of the most documented and continuously produced surface pattern objects in the world.

**Scale and production**: The first carré was produced in 1937 ("Jeu des omnibus et dames blanches"). Since then, Hermès has produced more than 3,000 unique designs. Two new collections are released annually, supplemented by reprints and limited editions. Each 90 × 90 cm scarf weighs 79 grams and requires the silk from 300 mulberry moth cocoons. Production is handled by Holding Textile Hermès (HTH) at Pierre-Bénite near Lyon, a facility of approximately 800 people, in a silk-weaving and screen-printing region where Hermès has maintained its textile production for decades.

**Surface design process**: Each carré design is developed by dedicated in-house designers, with individual designs taking up to 18 months to complete. Colours number approximately 70,000 choices across the archive. Screen printing is the primary production method; in 2020, Hermès introduced a secret double-sided printing technique that produces a scarf with a distinct colourway on each face — a significant technical innovation for the format. The "Brides de Gala" design (1957) is among the most reproduced in the archive, produced more than 70,000 times and, at peak commercial periods, selling at the rate of one every 25 seconds globally.

**Motif vocabulary**: Hermès scarves draw on a consistent vocabulary of equestrian, botanical, cartographic, and cultural motifs. Tuareg traditional motifs have been incorporated across the scarf range and other product categories. The Chaîne d'ancre bracelet (designed 1938 by Robert Dumas) is a widely recognised motif derived from equestrian chain links, extended across jewellery, scarves, and home objects.
...
- [[wiki/companies/_review/_staging_yaml_backup/marimekko]] (comparable position as a pattern-identified luxury textile brand)
