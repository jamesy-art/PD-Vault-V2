...
- Within 20 years: 80+ employees; internationally known for pocket watches; begins wristwatch production
- 1905: 150+ workers; company renamed Movado (Esperanto: "always in motion")
- 1947: Museum Watch designed by Nathan George Horwitt; Bauhaus-influenced single-dot dial symbolising the sun at high noon
- 1960: Horwitt's Museum Watch dial enters the permanent design collection of the Museum of Modern Art, New York — the first watch dial to receive this distinction
- 1975: Movado settles IP dispute with Horwitt for $29,000 (equivalent ~$174,000 in 2025); after Horwitt's death, Movado began heavy promotion of Horwitt and the Museum Watch
- 1983: Purchased by North American Watch Corporation (Gedalio Grinberg, Cuban-born)
- February 23, 1999: Movado Group completes sale of Piaget's business to VLG North America, Inc. for approximately $30 million
- May 19, 1999: *Time Sculpture* by Philip Johnson (bronze, granite base) dedicated outside Lincoln Center, New York City — a Movado commission
...
- **Concord** — luxury watch brand
- **EBEL** — Swiss luxury watch brand
- **Olivia Burton** — women's watch brand with botanical, floral, and pattern-led dial aesthetics
- **MVMT** — acquired August 2018 ($100M+); direct-to-consumer watch brand founded 2013; minimalist contemporary positioning

**Licensed brands** (watch manufacturing/distribution agreements):
...
Movado's connection to surface pattern design lies primarily in watch dial design as an object-surface practice, and secondarily through the Olivia Burton brand's explicit botanical and pattern vocabulary.

**The Museum Watch dial as minimalist surface design** — the Museum Watch (Nathan George Horwitt, 1947) is a canonical example of surface reduction as design decision: the elimination of numerals, hour markers, and decorative elements until only a single dot remains at the 12 o'clock position. Influenced directly by Bauhaus principles — the doctrine that every non-functional surface element should be removed — the dial is both a functional timepiece face and a surface design object. Edward Steichen described Horwitt's design as "the only truly original and beautiful one for such an object." The MoMA's acquisition in 1960 institutionalised the dial as a design artefact. The single-dot motif now anchors Movado's entire brand surface language.

**Watch dial design as surface practice** — the design of watch dials is structurally a surface design discipline: applying type, graphic elements, indices, colour, texture, and material finish to a small circular surface field. Movado's broader line includes dials with varying surface treatments, materials, and compositions. The Delphino series (two-tone black dial face) and the Motion smartwatch collections demonstrate range within this surface field.

**Olivia Burton** — the MVMT Group's Olivia Burton brand, acquired as part of the portfolio, is known for feminine watch dials with botanical, floral, and pattern-referencing dial compositions — including bees, butterflies, floral motifs, and painted effects. This makes Olivia Burton the most direct surface pattern design expression within the Movado Group portfolio, with dial surfaces functioning as miniature illustrated or patterned surfaces.

**Licensed brand surfaces** — Movado Group manufactures watches carrying the brand graphic surfaces of Coach, Hugo Boss, Lacoste, Tommy Hilfiger, and Calvin Klein. These products translate each fashion brand's visual language — Coach's C-monogram heritage, Lacoste's crocodile motif, Tommy's flag graphic — into watch dial and strap surface design.
...
- [[wiki/companies/_staging/mvmt]] — acquired August 2018 ($100M+); direct-to-consumer accessible watch brand
...
- [[wiki/companies/_review/_staging_yaml_backup/richemont]] — Piaget's parent company; Movado Group sold its Piaget business to VLG North America in 1999 for ~$30M
