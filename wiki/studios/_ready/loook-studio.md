...
Selected pattern images lean toward interior applications (wallcovering-style paisleys, abstract geometrics) alongside bold botanical prints suited to fashion, matching the studio's stated focus on weaving, bedding, and wallcovering alongside fashion work.
...
Documented clients include Grandeco Wallfashion, JAB Anstoetz, Marburger Tapetenfabrik, Irisette, Estella, Sentec International, AS Creation, Target, Next Home, Gebr. Munzert, Høie of Scandinavia, Fleuresse, Rasch, Beddinghouse, Ivy&Oak, GIVN, Ulla Popken, Nata y Limon, Laufer Fashion Consulting, Josef Otten, KBC Fashion, Verhees Textiles, and Innotex Textildruck. The studio has exhibited at Heimtextil (Frankfurt) and Maison et Objet (Paris).

## Portfolio and Presence

- Website: https://loook-studio.com/home.php
- Instagram: http://www.instagram.com/loookstudio
- Pattern Cloud: https://www.thepatterncloud.com/studio-directory/loook-studio

## Studio Background

Founder Lea Leiner worked as Senior Designer and Head of Design at a German printing mill for almost a decade before founding LOOOK in 2018, initially building the studio's interior-design division before expanding into fashion.

## Pattern Focus

Paisley and damask wallcovering motifs, botanical illustration, and bold graphic tropical florals, spanning muted interior palettes to saturated fashion colorways, per selected pattern images.
