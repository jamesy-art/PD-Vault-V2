...
images:
  editorial:
    ...
    - ../../../assets/types/orange-pattern/orange-pattern-2-pattern-designers.jpg
    - ../../../assets/types/orange-pattern/orange-pattern-3-pattern-designers.jpg
    - ../../../assets/types/orange-pattern/orange-pattern-4-pattern-designers.jpg
  profile:
    - ../../assets/types/orange-pattern/profile/orange-pattern-image.svg
editorial_image_data:
  - image: ../../../assets/types/orange-pattern/orange-pattern-1-pattern-designers.jpg
    ...
    url: https://www.magnific.com/free-photo/abstract-colorful-geometric-pattern-orange-yellow-red-stoneware-mosaic-texture-background-modern-style-wall-background_18487864.htm
  - image: ../../../assets/types/orange-pattern/orange-pattern-2-pattern-designers.jpg
    title: Flat design fruit and floral pattern design
    url: https://www.magnific.com/free-vector/flat-design-fruit-floral-pattern-design_28926645.htm
  - image: ../../../assets/types/orange-pattern/orange-pattern-3-pattern-designers.jpg
    title: Hand drawn orange fruit seamless pattern
    url: https://www.magnific.com/free-vector/hand-drawn-orange-fruit-seamless-pattern_27390167.htm
  - image: ../../../assets/types/orange-pattern/orange-pattern-4-pattern-designers.jpg
    title: Png orange pattern abstract zebra | Premium AI-generated PSD
    url: https://www.magnific.com/premium-psd/png-orange-pattern-abstract-zebra_369333052.htm
profile_image: ../../assets/types/orange-pattern/profile/orange-pattern-image.svg
profile_image_local: ../../assets/types/orange-pattern/profile/orange-pattern-image.svg
profile_images:
  - ../../assets/types/orange-pattern/profile/orange-pattern-image.svg
...
Orange in surface pattern reads as warm, active, and energetic. The specific orange shade dramatically changes the aesthetic character: burnt orange reads as earthy and autumnal; saffron reads as rich and sacred (Hindu and Buddhist associations); tangerine reads as bright and tropical; apricot reads as soft and pastel. Orange works as an accent colour in multi-coloured compositions and as a dominant ground colour in bold geometric and retro-aesthetic prints.
...
Orange as a colour name in English dates to the 16th century, derived from the Old French word for the orange fruit (itself from Arabic/Sanskrit origins). Before the fruit arrived in Europe, "orange" as a colour was described using words like "yellow-red" in English. The orange dye tradition in textiles includes: saffron (the most historically significant natural orange-yellow dye, used in South Asian and Mediterranean cultures); henna; and natural ochre pigments. The synthetic orange pigment and dye industry developed through the 19th century, enabling consistent bright orange reproduction. Saffron has been used as a dye and as a sacred colour in Hindu and Buddhist traditions since at least the 12th century. International orange was specified for the Golden Gate Bridge in 1937 to ensure the bridge's visibility in San Francisco's frequent fog.
...
| Image | Preview |
|---|---|
| 1 | <img src="../../../assets/types/orange-pattern/orange-pattern-1-pattern-designers.jpg" width="160"> |
| 2 | <img src="../../../assets/types/orange-pattern/orange-pattern-2-pattern-designers.jpg" width="160"> |
| 3 | <img src="../../../assets/types/orange-pattern/orange-pattern-3-pattern-designers.jpg" width="160"> |
| 4 | <img src="../../../assets/types/orange-pattern/orange-pattern-4-pattern-designers.jpg" width="160"> |
