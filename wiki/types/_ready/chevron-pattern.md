...
images:
  editorial:
    ...
    - ../../../assets/types/chevron-pattern/chevron-pattern-2-pattern-designers.jpg
    - ../../../assets/types/chevron-pattern/chevron-pattern-3-pattern-designers.jpg
    - ../../../assets/types/chevron-pattern/chevron-pattern-4-pattern-designers.jpg
  profile:
    - ../../assets/types/chevron-pattern/profile/chevron-pattern-image.svg
editorial_image_data:
  - image: ../../../assets/types/chevron-pattern/chevron-pattern-1-pattern-designers.jpg
    title: A black and white chevron zigzag pattern background | Premium Vector
    url: https://www.magnific.com/premium-vector/black-white-chevron-zigzag-pattern-background_387542513.htm
  - image: ../../../assets/types/chevron-pattern/chevron-pattern-2-pattern-designers.jpg
  ...
  - image: ../../../assets/types/chevron-pattern/chevron-pattern-3-pattern-designers.jpg
    title: Black dotted decorative pattern | Premium Vector
    url: https://www.magnific.com/premium-vector/black-dotted-decorative-pattern_21139965.htm
  - image: ../../../assets/types/chevron-pattern/chevron-pattern-4-pattern-designers.jpg
...
profile_image: ../../assets/types/chevron-pattern/profile/chevron-pattern-image.svg
profile_image_local: ../../assets/types/chevron-pattern/profile/chevron-pattern-image.svg
profile_images:
  - ../../assets/types/chevron-pattern/profile/chevron-pattern-image.svg
...
![pd-profile|160](../../assets/types/chevron-pattern/profile/chevron-pattern-image.svg)
A V-shaped geometric mark, one of the oldest decorative symbols in human history, long used in heraldry, insignia, and architectural ornament before becoming a staple zigzag motif in surface design.
...
- Single V-shaped chevron (point up or point down/inverted)
- Chevronny (repeating banded chevron field)
- Chevron wavy (curved-edge variant)
- Interlaced chevron and chevron-inverted pairs
- Éclaté chevron (splintered, irregular zigzag edge)

## Colour and Style

The source does not specify a colour palette for chevron pattern; heraldic examples shown use solid, high-contrast colour blocking (e.g. a single tincture chevron on a contrasting field), consistent with the motif's origin as a legible, high-contrast heraldic charge.
...
| Image | Preview |
|---|---|
| 1 | <img src="../../../assets/types/chevron-pattern/chevron-pattern-1-pattern-designers.jpg" width="160"> |
| 2 | <img src="../../../assets/types/chevron-pattern/chevron-pattern-2-pattern-designers.jpg" width="160"> |
| 3 | <img src="../../../assets/types/chevron-pattern/chevron-pattern-3-pattern-designers.jpg" width="160"> |
| 4 | <img src="../../../assets/types/chevron-pattern/chevron-pattern-4-pattern-designers.jpg" width="160"> |
