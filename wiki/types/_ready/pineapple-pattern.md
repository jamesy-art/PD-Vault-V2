...
images:
  editorial:
    ...
    - ../../../assets/types/pineapple-pattern/pineapple-pattern-2-pattern-designers.jpg
    - ../../../assets/types/pineapple-pattern/pineapple-pattern-3-pattern-designers.jpg
    - ../../../assets/types/pineapple-pattern/pineapple-pattern-4-pattern-designers.jpg
  profile:
    - ../../assets/types/pineapple-pattern/profile/pineapple-pattern-image.svg
editorial_image_data:
  - image: ../../../assets/types/pineapple-pattern/pineapple-pattern-1-pattern-designers.jpg
    title: Flat design summer duotone pattern
    url: https://www.magnific.com/free-vector/flat-design-summer-duotone-pattern_28345162.htm
  - image: ../../../assets/types/pineapple-pattern/pineapple-pattern-2-pattern-designers.jpg
    title: Pineapple fruit memphis style
    url: https://www.magnific.com/free-vector/pineapple-fruit-memphis-style_4520438.htm
  - image: ../../../assets/types/pineapple-pattern/pineapple-pattern-3-pattern-designers.jpg
    title: Pineapple fruits pattern illustration design | AI-generated image
    url: https://www.magnific.com/free-ai-image/pineapple-fruits-pattern-illustration-design_380602878.htm
  - image: ../../../assets/types/pineapple-pattern/pineapple-pattern-4-pattern-designers.jpg
    title: Realistic pineapple seamless pattern
    url: https://www.magnific.com/free-vector/realistic-pineapple-seamless-pattern_5975368.htm
profile_image: ../../assets/types/pineapple-pattern/profile/pineapple-pattern-image.svg
profile_image_local: ../../assets/types/pineapple-pattern/profile/pineapple-pattern-image.svg
profile_images:
  - ../../assets/types/pineapple-pattern/profile/pineapple-pattern-image.svg
...
Pineapple patterns occupy a specific position within the broader tropical and fruit pattern category: they carry a cultural legacy that elevates them beyond generic novelty fruit imagery. Historically, the pineapple represented hospitality, wealth, and exotic status in Colonial America, where the fruit's rarity and expense made it a meaningful gift and decorative statement. This symbolic weight persists in contemporary usage.

The pineapple pattern category also encompasses a distinct craft tradition: the crochet pineapple stitch, a recognised lace motif with a characteristic widening-then-narrowing teardrop structure. This craft application has given the pineapple pattern a textural, handmade presence alongside its graphic print applications.

## Visual Characteristics

The pineapple is a visually distinctive fruit: oval body covered in a geometric scale/diamond pattern, topped by a spiky crown of radiating leaves. Key visual elements for surface pattern design:

- **Scale pattern:** The hexagonal or diamond-shaped scales covering the fruit body; creates a natural geometric grid that complements repeat structure
- **Crown:** The spiky radiating leaf crown at the top; provides a strong silhouette
...
Pineapple motifs are used in several repeat structures:

- **Tossed all-over:** Individual pineapple motifs distributed at varied angles and scales across the tile; the most common commercial layout
- **Upright repeat:** Pineapples standing upright in a regular half-drop arrangement; ordered, formal
- **Stripe or band:** Pineapples in horizontal or diagonal stripe arrangements
- **Mixed tropical:** Pineapples combined with other tropical fruit, leaf, and flower motifs (flamingo, hibiscus, palm) in a larger tropical composition

## Common Motifs

- **Full pineapple:** The primary motif; upright, side-angled, or stylised
- **Pineapple cross-section:** Rare; shows internal flesh structure
- **Pineapple crown:** Isolated radiating leaf crown; used as a secondary element
- **Crochet pineapple:** The textile-derived teardrop lace form; used in fabric and wallpaper as a heritage craft reference
- **Supporting tropical elements:** Hibiscus, palm leaf, tropical bird, flamingo; contextual companions
...
- **Fashion and resort wear:** Swimwear, summer dresses, resort shirts; tropical and island aesthetic
- **Home textiles:** Tea towels, napkins, cushions; kitchen and outdoor dining
- **Wallpaper:** Tropical feature walls; resort and hotel interiors; children's rooms
- **Stationery and gifting:** Birthday and thank-you cards; wrapping paper with hospitality messaging
- **Tableware and ceramics:** Pineapple motifs on plates, mugs, and serving ware for summer entertaining
- **Craft and textiles:** Crochet pineapple stitch in doilies, shawls, and vintage-inspired textile work
...
- AI-generated source summary: Identifies three meanings of "pineapple pattern": (1) crochet/lace motif (teardrop-shaped, popular since mid-1800s, used in doilies/shawls/vintage clothing); (2) the natural geometric Fibonacci scale arrangement of the fruit (intersecting spirals of 5, 8, 13); (3) cultural hospitality and social symbolism (Colonial American wealth/status symbol; contemporary "upside-down pineapple" social signal). SPD applications: fabric, wallpaper, and decorative backgrounds.

## Editorial Images

| Image | Preview |
|---|---|
| 1 | <img src="../../../assets/types/pineapple-pattern/pineapple-pattern-1-pattern-designers.jpg" width="160"> |
| 2 | <img src="../../../assets/types/pineapple-pattern/pineapple-pattern-2-pattern-designers.jpg" width="160"> |
| 3 | <img src="../../../assets/types/pineapple-pattern/pineapple-pattern-3-pattern-designers.jpg" width="160"> |
| 4 | <img src="../../../assets/types/pineapple-pattern/pineapple-pattern-4-pattern-designers.jpg" width="160"> |
