...
images:
  editorial:
    ...
    - ../../../assets/types/emoji-pattern/emoji-pattern-2-pattern-designers.jpg
    - ../../../assets/types/emoji-pattern/emoji-pattern-3-pattern-designers.jpg
    - ../../../assets/types/emoji-pattern/emoji-pattern-4-pattern-designers.jpg
  profile:
    - ../../assets/types/emoji-pattern/profile/emoji-pattern-image.svg
editorial_image_data:
  - image: ../../../assets/types/emoji-pattern/emoji-pattern-1-pattern-designers.jpg
    title: Gradient emoji with face mask pattern
    url: https://www.magnific.com/free-vector/gradient-emoji-with-face-mask-pattern_16635590.htm
  - image: ../../../assets/types/emoji-pattern/emoji-pattern-2-pattern-designers.jpg
    ...
    url: https://www.magnific.com/premium-vector/seamless-pattern-with-emoji-smiles-love-messages-social-media-elements-textile-design-vector-illustration_249291764.htm
  - image: ../../../assets/types/emoji-pattern/emoji-pattern-3-pattern-designers.jpg
    title: Smiling emoji black line smile icons seamless vector pattern isolated on yellow background | Premium Vector
    url: https://www.magnific.com/premium-vector/smiling-emoji-black-line-smile-icons-seamless-vector-pattern-isolated-yellow-background_45162640.htm
  - image: ../../../assets/types/emoji-pattern/emoji-pattern-4-pattern-designers.jpg
    title: Smiling emoji smile icons seamless vector pattern isolated pink ackground | Premium Vector
    url: https://www.magnific.com/premium-vector/smiling-emoji-smile-icons-seamless-vector-pattern-isolated-pink-ackground_45162639.htm
profile_image: ../../assets/types/emoji-pattern/profile/emoji-pattern-image.svg
profile_image_local: ../../assets/types/emoji-pattern/profile/emoji-pattern-image.svg
profile_images:
  - ../../assets/types/emoji-pattern/profile/emoji-pattern-image.svg
...
- Yellow smiley face and expression emoji (😂, 😍, 😎)
- Heart and love symbols (❤️, 💕)
- Food and drink (🍕, 🍦, 🍔)
- Animal emoji (🐱, 🐶, 🦋)
...
Bold, saturated, multi-coloured palettes reflecting the screen-optimised original designs. High contrast and visually energetic. The aesthetic is digital-native, pop cultural, and immediately contemporary. Most commercially active in children's and teen markets; also active in novelty gifting, stationery, and seasonal product categories.
...
- Children's apparel and nursery textiles
- Teen fashion (T-shirts, accessories, swimwear)
- Seasonal novelty gifting and wrapping paper
- Stationery: notebooks, greeting cards
- Phone cases and tech accessories
- Party supplies and seasonal products
...
| Image | Preview |
|---|---|
| 1 | <img src="../../../assets/types/emoji-pattern/emoji-pattern-1-pattern-designers.jpg" width="160"> |
| 2 | <img src="../../../assets/types/emoji-pattern/emoji-pattern-2-pattern-designers.jpg" width="160"> |
| 3 | <img src="../../../assets/types/emoji-pattern/emoji-pattern-3-pattern-designers.jpg" width="160"> |
| 4 | <img src="../../../assets/types/emoji-pattern/emoji-pattern-4-pattern-designers.jpg" width="160"> |
