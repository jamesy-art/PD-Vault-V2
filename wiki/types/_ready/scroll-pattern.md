...
images:
  editorial:
    ...
    - ../../../assets/types/scroll-pattern/scroll-pattern-2-pattern-designers.jpg
    - ../../../assets/types/scroll-pattern/scroll-pattern-3-pattern-designers.jpg
    - ../../../assets/types/scroll-pattern/scroll-pattern-4-pattern-designers.jpg
  profile:
    - ../../assets/types/scroll-pattern/profile/scroll-pattern-image.svg
editorial_image_data:
  - image: ../../../assets/types/scroll-pattern/scroll-pattern-1-pattern-designers.jpg
    title: Damask seamless pattern
    url: https://www.magnific.com/free-vector/damask-seamless-pattern_9136728.htm
  - image: ../../../assets/types/scroll-pattern/scroll-pattern-2-pattern-designers.jpg
    title: Green and white swirling pattern
    url: https://www.magnific.com/free-vector/green-white-swirling-pattern_417400834.htm
  - image: ../../../assets/types/scroll-pattern/scroll-pattern-3-pattern-designers.jpg
    title: Vector damask seamless pattern element
    url: https://www.magnific.com/free-vector/vector-damask-seamless-pattern-element_9662894.htm
  - image: ../../../assets/types/scroll-pattern/scroll-pattern-4-pattern-designers.jpg
    ...
    url: https://www.magnific.com/premium-vector/vintage-baroque-victorian-frame-border-flower-pattern-vector-floral-engraved-scroll-ornament-leaf-retro-decorative-design-filigree-calligraphic-heraldic-shield-swirl_420723953.htm
profile_image: ../../assets/types/scroll-pattern/profile/scroll-pattern-image.svg
profile_image_local: ../../assets/types/scroll-pattern/profile/scroll-pattern-image.svg
profile_images:
  - ../../assets/types/scroll-pattern/profile/scroll-pattern-image.svg
...
![pd-profile|160](../../assets/types/scroll-pattern/profile/scroll-pattern-image.svg)
A continuous flowing stem-based decorative pattern with spiralling, curling, or branching tendrils; one of the oldest and most continuously used motif traditions in Western and Islamic decorative art, traceable from Minoan Crete (c.1800 BC) through Greek and Roman classical ornament, Islamic arabesque, Ottoman textiles, Renaissance design, and the Victorian Arts and Crafts revival to contemporary wallpaper and fashion fabric.
...
Scroll patterns are defined by:
...
Density ranges from sparse vine-and-tendril structures with significant ground showing, to dense interlocking all-over compositions where no ground is visible.

## Pattern Structure

The scroll pattern uses a flowing all-over repeat in which the stem structure provides the repeat unit. The stem connects diagonally or horizontally across the tile, with vertical branching creating the surface coverage. Well-constructed scroll repeats obscure their tile boundaries through the natural logic of branching plant growth.

Structural variants include:

- **Rinceau:** The classical Roman name for the formalised scroll ornament; acanthus-based; precise and architectural
- **Arabesque:** The Islamic geometric variant; typically avoids naturalistic plant forms; uses geometric precision to produce the same flowing structure
- **Inhabited scroll (rinceaux):** Medieval European tradition; figures (angels, animals, men) seated within the scroll stems
- **Vine scroll / vinescroll:** Specifically grape vine-based; Roman and Byzantine; used in mosaic and manuscript decoration
- **S-scroll / C-scroll:** Single-direction scrolls used as border elements rather than field-filling all-overs
- **Meander (key pattern):** The Greek border scroll; angular, geometric; a different tradition from the organic vine scroll

## Common Motifs

- **Acanthus:** The canonical classical scroll leaf; deeply lobed, formal; foundational in Corinthian capitals and Roman rinceau
- **Palmette:** Stylised palm or lotus flower head; common terminal or junction motif in classical and Islamic scroll design
- **Vine and grape:** The Roman and early Christian vine scroll tradition; clusters of grapes as fill elements
...
Scroll pattern colour varies significantly by tradition and period:
...
- **Wallpaper:** One of the most commercially persistent categories; classical rinceau, Morris-revival, and Art Nouveau scroll wallpapers are in continuous production
- **Furnishing fabric:** Heavyweight furnishing jacquard and printed upholstery fabric; scroll patterns coordinate with traditional interiors
- **Fashion fabric:** Brocade and jacquard woven fabric with scroll structures; used in tailoring, eveningwear, and structured fashion
- **Borders and edgings:** S-scrolls and C-scrolls as textile border ornament; trim applications
- **Ceramics and tile:** Scroll border patterns on tableware; Delftware and Majolica traditions
- **Licensing / heritage reproduction:** Classical, Arts and Crafts, and Art Nouveau scroll designs are commercially reproduced by heritage institutions (V&A, Liberty) and wallpaper houses (Cole & Son, Sanderson)
...
| Image | Preview |
|---|---|
| 1 | <img src="../../../assets/types/scroll-pattern/scroll-pattern-1-pattern-designers.jpg" width="160"> |
| 2 | <img src="../../../assets/types/scroll-pattern/scroll-pattern-2-pattern-designers.jpg" width="160"> |
| 3 | <img src="../../../assets/types/scroll-pattern/scroll-pattern-3-pattern-designers.jpg" width="160"> |
| 4 | <img src="../../../assets/types/scroll-pattern/scroll-pattern-4-pattern-designers.jpg" width="160"> |
